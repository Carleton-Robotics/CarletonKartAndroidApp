...
public class LaneDetector extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.LaneDetectorView);
        mOpenCvCameraView.setVisibility(SurfaceView.VISIBLE);
        mOpenCvCameraView.setCvCameraViewListener(this);

        //Intent intent = getIntent();
        //houghValue = Integer.parseInt(intent.getStringExtra("houghvalue"));
        houghValue = 150;
